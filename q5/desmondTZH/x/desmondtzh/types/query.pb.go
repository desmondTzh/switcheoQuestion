...
func init() {
	...
	proto.RegisterType((*QuerySayHelloRequest)(nil), "desmondtzh.desmondtzh.QuerySayHelloRequest")
	proto.RegisterType((*QuerySayHelloResponse)(nil), "desmondtzh.desmondtzh.QuerySayHelloResponse")
}
...
var fileDescriptor_71231f928095fd66 = []byte{
	...
	0xcd, 0xcf, 0x4b, 0x29, 0xa9, 0xca, 0xd0, 0x47, 0x62, 0x16, 0x96, 0xa6, 0x16, 0x55, 0xea, 0x15,
	...
	,
}
...
func (c *queryClient) SayHello(ctx context.Context, in *QuerySayHelloRequest, opts ...grpc.CallOption) (*QuerySayHelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/desmondtzh.desmondtzh.Query/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/desmondtzh.desmondtzh.Query/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
